...
data = "The function f is convex on the interval I iff for every a, b ∈ I, the line segment between the points (a, f(a)) and (b, f(b)) is always above or on the curve f. Analogously, f is concave iff the line segment always lies below or on the curve. "
pipe = Pipeline(data, "Convex Functions")